  ...
  describe '#class_methods' do
    describe '.load_config_file' do
      it 'should know how to load a config_path from a folder' do
        ...
        expect(CookieCutter::Recipe.read_config_file(config_dir)).to eql(expected_yml)
      end
      it 'should know how to load a config_path from a file' do
        ...
        expect(CookieCutter::Recipe.read_config_file(config_file)).to eql(_expected_yml)
      end
    end
    ...
    describe '.config_is_dir' do
      it 'should know if config_path is a folder' do
        path = '~'
        expect(CookieCutter::Recipe.config_is_dir(path)).to be true
      end
    end
  end
end
